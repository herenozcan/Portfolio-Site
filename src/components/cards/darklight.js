import GetirImg from "../../images/darklightmode.jpg";
        ...
        <div className="p-6">
          <header className="flex gap-4">
            <div>
              ...
              <p className="text-sm text-slate-400">27/05/2023</p>
            </div>
          </header>
        </div>
        <figure className="">
          <img
            src={GetirImg}
            alt=""
            className="bg-[#343433c1] p-4 h-[440px] w-full"
          />
        </figure>
        <div className="p-6">
          <p>
            A Dark/Light Mode Toggle was created using React.js and Tailwind
            CSS.
          </p>
        </div>
