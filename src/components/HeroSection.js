  ...
  return(
    <div className="container mx-auto">
      <div className="flex flex-col md:flex-row items-center justify-center text-center">
        ...
        <div className="pt-12">
          <div className="animate-fade-in-down mb-1 text-center text-xl font-bold dark:text-gray-300 ml-12">Eren Ozcan</div>
          <div className="animate-fade-in-down mb-8 text-center text-lg dark:text-gray-300 ml-12">Front-End Developer</div>
          <blockquote>
